...
if(NOT "/home/demo/hackaton/services-pkg/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'chemistry_services' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/demo/hackaton/services-pkg/src/chemistry_services/${idir}'.  ${_report}")
    endif()
